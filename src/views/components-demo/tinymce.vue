<template>
  <div class="components-container">
    <aside>
      ...
      <a target="_blank" class="link-type" href="https://kjd1000000.github.io/vue-element-admin-site/feature/component/rich-editor.html"> {{ $t('components.documentation') }}</a>
    </aside>
    <div>
